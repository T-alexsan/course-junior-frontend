...
console.log("Значение переменной bestProgrammingLanguage1 равно " + bestProgrammingLanguage1 + " а ее тип " + typeof bestProgrammingLanguage1);
console.log("Значение переменной bestProgrammingLanguage2 равно " + bestProgrammingLanguage2 + " а ее тип " + typeof bestProgrammingLanguage2);
...
console.log("Переменная var является устаревшей");
